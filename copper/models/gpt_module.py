...
class GPTDecoderBlock(nn.Module):
    def __init__(
        ...
        self.mha = MultiHeadAttention(n_heads=self.n_heads, n_dim=emb_size, dropout=self.drop_p)
...
class GPT(nn.Module):
    def __init__(self, vocab_size, block_size, n_embed, n_heads, drop_p, n_decoder_blocks):
        ...
        self.blocks = nn.ModuleList([
            GPTDecoderBlock(emb_size=n_embed, n_heads=self.n_heads, drop_p=self.drop_p)] * self.n_decoder_blocks
            )
